...
function goHome()
{
  document.getElementById("browser").loadURL("https://search.nnisarg.xyz");
}
...
function go()
{
  ...
  if (string_searched.startsWith("@y ")){
    string_searched = "https://youtube.com/search?&q=" + string_searched.replace("@y ", "");
  }
  else if (string_searched.startsWith("@g ")){
    string_searched = "https://google.com/search?&q=" + string_searched.replace("@g ", "");
  }
